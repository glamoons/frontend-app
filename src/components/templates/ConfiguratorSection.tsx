	...
	return (
		<Section className="3xl:container 3xl:rounded-3xl bg-primaryLight">
			<div className="tablet:flex tablet:flex-row container mx-auto">
				<div className="tablet:w-1/2 tablet:min-h-max tablet:mr-[1.563rem] tablet:mt-0 tabletLg:items-start mt-[-50px] flex min-h-[390px] flex-col items-center justify-center space-y-6">
					<SectionHeading
				...
				<div className="tablet:w-1/2 tablet:mx-0 tablet:mt-[-50px] tablet:mr-[-1.563rem] relative mx-[-1.563rem] mb-[-50px] h-[390px]">
